...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['appointment_id']) && isset($_POST['status'])) {
    ...
    $sql = "UPDATE hospital_appointments SET status = ? WHERE id = ?";
...
// Fetch appointments associated with the hospital
$sql = "SELECT * FROM hospital_appointments WHERE hospital_id = ?";
$stmt = $conn->prepare($sql);
...
<body>
    ...
    <div class="top-bar">
        <span class="welcome-message">Welcome, <?php echo htmlspecialchars($_SESSION['hospital_name']); ?></span>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="">
                                ...
                                <button type="submit" class="status-btn <?php echo $row['status'] == 'Checked' ? 'checked' : 'unchecked'; ?>"><?php echo htmlspecialchars($row['status']); ?></button>
                            </form>
                        </td>
                    </tr>
                <?php endwhile; ?>
